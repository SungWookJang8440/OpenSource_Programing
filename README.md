...
이를 해결하기 위해 **TADD(Test+AI Driven Development) 방법론**과 **객체지향 설계(Strategy Pattern)**를 도입하여 코드 스멜을 제거하고 구조를 개선했습니다. 또한, 협업 생태계를 위해 Flasgger와 Sphinx를 활용한 자동화된 문서 환경(Single Source of Truth)을 구축했습니다.
